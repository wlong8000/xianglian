...
/**
 * Interface for implementing a controller that works with
 * {@link ZoomableDraweeView} to control the zoom.
 */
public interface ZoomableController {

    /**
     * Gets whether the controller is enabled. This should return the last value
     * passed to {@link #setEnabled}.
     *
    ...
    /**
     * Sets the listener for the controller to call back when the matrix
     * changes.
     *
