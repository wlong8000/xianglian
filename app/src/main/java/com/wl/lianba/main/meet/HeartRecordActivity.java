 ...
 * 心动记录
 */
public class HeartRecordActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupTitle(getString(R.string.heart_record));
    ...
    private void init() {
        ...
        mTabLayout.setupData(new ArrayList<String>() {
            {
                add(getString(R.string.love_me));
                add(getString(R.string.ta_love));
            }
        }, 0);
    ...
    class MyAdapter extends FragmentStatePagerAdapter {
        Fragment[] fragments = new Fragment[]{
                HeardRecordFragment.newInstance(),
                HeardRecordFragment.newInstance()
        };
