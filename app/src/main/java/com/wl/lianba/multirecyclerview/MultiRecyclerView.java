...
import static com.wl.lianba.R.styleable.MultiRecyclerView;
...
public class MultiRecyclerView extends RecyclerView {
    ...
    private void setState(int state) {
        ...
        if(mState == STATE_COMPLETE){
            mFootView.setText(R.string.loading_empty);
        }else if(mState == STATE_LOADING){
            mFootView.setText(R.string.loading);
        }
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        private class SimpleViewHolder extends ViewHolder {
            public SimpleViewHolder(View itemView) {
                super(itemView);
                mFootView = (TextView) itemView.findViewById(R.id.tv_load_more);
            }
        }
    }
