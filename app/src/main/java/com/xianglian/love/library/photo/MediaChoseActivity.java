package com.xianglian.love.library.photo;
...
import com.xianglian.love.library.photo.util.StatusBarCompat;
...
public class MediaChoseActivity extends ActionBarActivity {
    ...
    public LinkedHashMap imageMap = new LinkedHashMap();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        max_chose_count = bundle.getInt(PickConfig.EXTRA_MAX_SIZE, PickConfig.DEFAULT_PICK_SIZE);
        isneedCrop = bundle.getBoolean(PickConfig.EXTRA_IS_NEED_CROP, false);
        isNeedCamera = bundle.getBoolean(PickConfig.EXTRA_IS_NEED_CAMERA, true);
    ...
    public void starPriview(LinkedHashMap map, String currentimage) {
        if (isneedCrop && !isCropOver) {
            ...
            FragmentTransaction fragmentTransaction =
                    getSupportFragmentManager().beginTransaction();
            fragmentTransaction.add(R.id.container, ImagePreviewFragment.newInstance(ims, pos), ImagePreviewFragment.class.getSimpleName());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (imageMap.size() < 1) {
            ...
            if (chosemode == PickConfig.MODE_MULTIP_PICK) {
                menu.findItem(R.id.menu_photo_count).setTitle("发送(" + imageMap.size() + "/" + max_chose_count + ")");
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            ImagePreviewFragment fragment = (ImagePreviewFragment) getCurrentFragment(ImagePreviewFragment.class.getSimpleName());
            if (fragment != null) {
