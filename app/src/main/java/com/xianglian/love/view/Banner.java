...
import com.xianglian.love.interfacepackage.ImageLoaderInterface;
import com.xianglian.love.interfacepackage.OnBannerClickListener;
import com.xianglian.love.interfacepackage.OnBannerListener;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int delayTime = Config.TIME;
    private int scrollTime = Config.DURATION;
    private boolean isAutoPlay = Config.IS_AUTO_PLAY;
    private boolean isScroll = Config.IS_SCROLL;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_margin, Config.PADDING_SIZE);
        ...
        delayTime = typedArray.getInt(R.styleable.Banner_delay_time, Config.TIME);
        scrollTime = typedArray.getInt(R.styleable.Banner_scroll_time, Config.DURATION);
        isAutoPlay = typedArray.getBoolean(R.styleable.Banner_is_auto_play, Config.IS_AUTO_PLAY);
        titleBackground = typedArray.getColor(R.styleable.Banner_title_background, Config.TITLE_BACKGROUND);
        titleHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_title_height, Config.TITLE_HEIGHT);
        titleTextColor = typedArray.getColor(R.styleable.Banner_title_textcolor, Config.TITLE_TEXT_COLOR);
        titleTextSize = typedArray.getDimensionPixelSize(R.styleable.Banner_title_textsize, Config.TITLE_TEXT_SIZE);
