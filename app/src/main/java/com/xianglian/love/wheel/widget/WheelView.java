...
package com.xianglian.love.wheel.widget;
...
import com.xianglian.love.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    /**
     * Left and right marginNavigationBar value
     */
...
//            drawShadows(canvas);
    ...
    private View getItemView(int index) {
        ...
        index %= count;
        TextView textView = (TextView) viewAdapter.getItem(index, recycle.getItem(), itemsLayout);
...
//        } else if (Math.abs(getCurrentItem() - index) == 1) {
//            textView.setTextColor(0xaa333333);
//        } else if (Math.abs(getCurrentItem() - index) == 2) {
//            textView.setTextColor(0x33333333);
//        }
//        Trace.e("",getCurrentItem()+"   "+index+"   "+Math.abs(getCurrentItem() - index) );
        return textView;
    }
