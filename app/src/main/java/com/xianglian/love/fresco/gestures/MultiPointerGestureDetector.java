...
package com.xianglian.love.fresco.gestures;
 ...
 * will end, and a new one will be started (if there are still pressed pointers
 * left). It is guaranteed that the number of pointers within the single gesture
 * will remain the same during the whole gesture.
 */
public class MultiPointerGestureDetector {
    ...
    /**
     * Gets the index of the i-th pressed pointer. Normally, the index will be
     * equal to i, except in the case when the pointer is released.
     *
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                // we'll restart the current gesture (if any) whenever the
                // number of pointers changes
                // NOTE: we only restart existing gestures here, new gestures
                // are started in ACTION_MOVE
    ...
    /**
     * Gets the start X coordinates for the all pointers Mutable array is
     * exposed for performance reasons and is not to be modified by the callers.
     */
    ...
    /**
     * Gets the start Y coordinates for the all pointers Mutable array is
     * exposed for performance reasons and is not to be modified by the callers.
     */
    ...
    /**
     * Gets the current X coordinates for the all pointers Mutable array is
     * exposed for performance reasons and is not to be modified by the callers.
     */
    ...
    /**
     * Gets the current Y coordinates for the all pointers Mutable array is
     * exposed for performance reasons and is not to be modified by the callers.
     */
