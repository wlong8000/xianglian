...
public class DeserializeBeanInfo {
    ...
    public static DeserializeBeanInfo computeSetters(Class<?> clazz) throws JSONException {
        return computeSetters(clazz, clazz);
    }

    public static DeserializeBeanInfo computeSetters(Class<?> clazz, Type type) throws JSONException {
    ...
    public static Constructor<?> getCreatorConstructor(Class<?> clazz) throws JSONException {
    ...
    public static Method getFactoryMethod(Class<?> clazz) throws JSONException {
