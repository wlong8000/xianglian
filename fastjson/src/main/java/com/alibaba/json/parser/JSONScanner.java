...
import static com.alibaba.json.parser.JSONToken.COLON;
import static com.alibaba.json.parser.JSONToken.COMMA;
...
import static com.alibaba.json.parser.JSONToken.LPAREN;
import static com.alibaba.json.parser.JSONToken.RBRACE;
import static com.alibaba.json.parser.JSONToken.RBRACKET;
import static com.alibaba.json.parser.JSONToken.RPAREN;
...
public class JSONScanner {
    ...
    public final void nextTokenWithColon() throws JSONException {
        for (;;) {
            if (ch == ':') {
                ch = buf[++bp];
                nextToken();
    ...
    public final void nextTokenWithColon(int expect) throws JSONException {
        for (;;) {
            if (ch == ':') {
                ch = buf[++bp];
                break;
    ...
    public void nextToken(int expect) throws JSONException {
        for (;;) {
            switch (expect) {
    ...
    public final void nextToken() throws JSONException {
        sp = 0;
    ...
    public final void scanStringSingleQuote() throws JSONException {
        np = bp;
        hasSpecial = false;
        char ch;
        for (;;) {
    ...
    public final void scanString() throws JSONException {
        np = bp;
        hasSpecial = false;
        char ch;
        for (;;) {
    ...
    public final String scanSymbolUnQuoted(final SymbolTable symbolTable) throws JSONException {
    ...
    public boolean matchField(char[] fieldName) throws JSONException {
    ...
    public ArrayList<String> scanFieldStringArray(char[] fieldName) throws JSONException {
        return (ArrayList<String>) scanFieldStringArray(fieldName, null);
    }

    @SuppressWarnings("unchecked")
    public Collection<String> scanFieldStringArray(char[] fieldName, Class<?> type) throws JSONException {
        matchStat = UNKOWN;
    ...
    public String scanSymbol(final SymbolTable symbolTable) throws JSONException {
        skipWhitespace();
    ...
    public final String scanSymbol(final SymbolTable symbolTable, final char quote) throws JSONException {
        int hash = 0;
    ...
    public void scanTrue() throws JSONException {
        if (buf[bp++] != 't') {
    ...
    public void scanSet() throws JSONException {
        if (buf[bp++] != 'S') {
            throw new JSONException("error parse true");
        }
        if (buf[bp++] != 'e') {
    ...
    public void scanTreeSet() throws JSONException {
        if (buf[bp++] != 'T') {
            throw new JSONException("error parse true");
        }
        if (buf[bp++] != 'r') {
    ...
    public void scanNullOrNew() throws JSONException {
        if (buf[bp++] != 'n') {
    ...
    public void scanFalse() throws JSONException {
        if (buf[bp++] != 'f') {
