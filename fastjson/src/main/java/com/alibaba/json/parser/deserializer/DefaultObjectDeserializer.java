...
public class DefaultObjectDeserializer implements ObjectDeserializer {
    ...
    public Object parseMap(DefaultJSONParser parser, Map<Object, Object> map, Type keyType, Type valueType,
                           Object fieldName) throws JSONException {
    ...
    public Map parseMap(DefaultJSONParser parser, Map<String, Object> map, Type valueType,
            Object fieldName) throws JSONException {
        JSONScanner lexer = (JSONScanner)parser.getLexer();
    ...
    public void parseObject(DefaultJSONParser parser, Object object) throws JSONException {
    ...
    public <T> T deserialze(DefaultJSONParser parser, ParameterizedType type, Object fieldName) throws JSONException {
        try {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public <T> T deserialze(DefaultJSONParser parser, Class<T> clazz) throws JSONException {
        Object value = null;
