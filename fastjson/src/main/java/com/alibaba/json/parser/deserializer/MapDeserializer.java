...
public class MapDeserializer implements ObjectDeserializer {
    ...
    protected Object deserialze(DefaultJSONParser parser, Type type, Object fieldName, Map map)
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (String.class == keyType) {
                return DefaultObjectDeserializer.instance.parseMap(parser,
                        (Map<String, Object>)map, valueType, fieldName);
            } else {
                return DefaultObjectDeserializer.instance.parseMap(parser, map, keyType, valueType,
                        fieldName);
            }
        } else {
    ...
    protected Map<Object, Object> createMap(Type type) throws JSONException {
