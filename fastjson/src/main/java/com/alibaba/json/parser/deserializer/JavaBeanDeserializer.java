...
import com.alibaba.json.util.DeserializeBeanInfo;
...
public class JavaBeanDeserializer implements ObjectDeserializer {
    ...
    public JavaBeanDeserializer(ParserConfig config, Class<?> clazz) throws JSONException {
        this(config, clazz, clazz);
    }

    public JavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type) throws JSONException {
        this.clazz = clazz;
        this.type = type;
    ...
    private void addFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo) throws JSONException {
    ...
    public Object createInstance(DefaultJSONParser parser, Type type) throws JSONException {
