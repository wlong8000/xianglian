...
import com.alibaba.json.parser.deserializer.ArrayListStringFieldDeserializer;
import com.alibaba.json.parser.deserializer.ArrayListTypeDeserializer;
import com.alibaba.json.parser.deserializer.ArrayListTypeFieldDeserializer;
import com.alibaba.json.parser.deserializer.BigDecimalDeserializer;
import com.alibaba.json.parser.deserializer.BigIntegerDeserializer;
import com.alibaba.json.parser.deserializer.BooleanDeserializer;
import com.alibaba.json.parser.deserializer.BooleanFieldDeserializer;
import com.alibaba.json.parser.deserializer.CalendarDeserializer;
import com.alibaba.json.parser.deserializer.CharArrayDeserializer;
import com.alibaba.json.parser.deserializer.CharacterDeserializer;
import com.alibaba.json.parser.deserializer.ClassDerializer;
import com.alibaba.json.parser.deserializer.CollectionDeserializer;
import com.alibaba.json.parser.deserializer.DateDeserializer;
import com.alibaba.json.parser.deserializer.DateFormatDeserializer;
import com.alibaba.json.parser.deserializer.DefaultFieldDeserializer;
import com.alibaba.json.parser.deserializer.DefaultObjectDeserializer;
import com.alibaba.json.parser.deserializer.EnumDeserializer;
...
import com.alibaba.json.parser.deserializer.IntegerFieldDeserializer;
...
import com.alibaba.json.parser.deserializer.JavaBeanDeserializer;
import com.alibaba.json.parser.deserializer.JavaObjectDeserializer;
...
import com.alibaba.json.parser.deserializer.LongFieldDeserializer;
import com.alibaba.json.parser.deserializer.MapDeserializer;
...
import com.alibaba.json.parser.deserializer.StackTraceElementDeserializer;
import com.alibaba.json.parser.deserializer.StringDeserializer;
import com.alibaba.json.parser.deserializer.StringFieldDeserializer;
import com.alibaba.json.parser.deserializer.ThrowableDeserializer;
import com.alibaba.json.parser.deserializer.TimeDeserializer;
...
public class ParserConfig {
    ...
    public ObjectDeserializer getDeserializer(Type type) throws JSONException {
    ...
    public ObjectDeserializer getDeserializer(Class<?> clazz, Type type) throws JSONException {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> clazz) throws JSONException {
        return createJavaBeanDeserializer(clazz, clazz);
    }

    public ObjectDeserializer createJavaBeanDeserializer(Class<?> clazz, Type type) throws JSONException {
    ...
    public FieldDeserializer createFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo) throws JSONException {
        return createFieldDeserializerWithoutASM(mapping, clazz, fieldInfo);
    }

    public FieldDeserializer createFieldDeserializerWithoutASM(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo) throws JSONException {
    ...
    public ObjectDeserializer getDeserializer(FieldInfo fieldInfo) throws JSONException {
    ...
    public Map<String, FieldDeserializer> getFieldDeserializers(Class<?> clazz) throws JSONException {
