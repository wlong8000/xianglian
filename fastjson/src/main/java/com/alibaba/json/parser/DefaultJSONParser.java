...
import com.alibaba.json.parser.deserializer.DefaultObjectDeserializer;
...
import com.alibaba.json.parser.deserializer.ListResolveFieldDeserializer;
import com.alibaba.json.parser.deserializer.MapResolveFieldDeserializer;
...
import static com.alibaba.json.parser.JSONScanner.EOI;
import static com.alibaba.json.parser.JSONToken.EOF;
import static com.alibaba.json.parser.JSONToken.ERROR;
import static com.alibaba.json.parser.JSONToken.FALSE;
import static com.alibaba.json.parser.JSONToken.LBRACE;
import static com.alibaba.json.parser.JSONToken.LBRACKET;
import static com.alibaba.json.parser.JSONToken.LITERAL_FLOAT;
import static com.alibaba.json.parser.JSONToken.LITERAL_INT;
import static com.alibaba.json.parser.JSONToken.LITERAL_STRING;
import static com.alibaba.json.parser.JSONToken.NEW;
import static com.alibaba.json.parser.JSONToken.NULL;
import static com.alibaba.json.parser.JSONToken.RBRACKET;
import static com.alibaba.json.parser.JSONToken.SET;
import static com.alibaba.json.parser.JSONToken.TREE_SET;
import static com.alibaba.json.parser.JSONToken.TRUE;
...
public class DefaultJSONParser extends AbstractJSONParser {
    ...
    public DefaultJSONParser(String input) throws JSONException {
        this(input, ParserConfig.getGlobalInstance(), JSON.DEFAULT_PARSER_FEATURE);
    }

    public DefaultJSONParser(final String input, final ParserConfig config) throws JSONException {
        this(input, new JSONScanner(input, JSON.DEFAULT_PARSER_FEATURE), config);
    }

    public DefaultJSONParser(final String input, final ParserConfig config, int features) throws JSONException {
        this(input, new JSONScanner(input, features), config);
    }

    public DefaultJSONParser(final char[] input, int length, final ParserConfig config, int features) throws JSONException {
        this(input, new JSONScanner(input, length, features), config);
    }

    public DefaultJSONParser(final Object input, final JSONScanner lexer, final ParserConfig config) throws JSONException {
        this.lexer = lexer;
        this.input = input;
        this.config = config;
    ...
    public final Object parseObject(final Map object, Object fieldName) throws JSONException {
    ...
    public <T> T parseObject(Class<T> clazz) throws JSONException {
        return (T) parseObject((Type) clazz);
    }

    @SuppressWarnings("unchecked")
    public <T> T parseObject(Type type) throws JSONException {
    ...
    public <T> List<T> parseArray(Class<T> clazz) throws JSONException {
        List<T> array = new ArrayList<T>();
        parseArray(clazz, array);
        return array;
    }

    public void parseArray(Class<?> clazz, @SuppressWarnings("rawtypes") Collection array) throws JSONException {
        parseArray((Type) clazz, array);
    }

    @SuppressWarnings("rawtypes")
    public void parseArray(Type type, Collection array) throws JSONException {
        parseArray(type, array, null);
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void parseArray(Type type, Collection array, Object fieldName) throws JSONException {
    ...
    public Object[] parseArray(Type[] types) throws JSONException {
        if (lexer.token() == JSONToken.NULL) {
            lexer.nextToken(JSONToken.COMMA);
            return null;
        }
    ...
    public void parseObject(Object object) throws JSONException {
        derializer.parseObject(this, object);
    }

    public Object parseArrayWithType(Type collectionType) throws JSONException {
        if (lexer.token() == JSONToken.NULL) {
            lexer.nextToken();
            return null;
        }
    ...
    public void acceptType(String typeName) throws JSONException {
        JSONScanner lexer = (JSONScanner) this.lexer;
    ...
    @SuppressWarnings("rawtypes")
    public Object parseObject(final Map object) throws JSONException {
    ...
    @SuppressWarnings("rawtypes")
    public final void parseArray(final Collection array) throws JSONException {
        parseArray(array, null);
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    public final void parseArray(final Collection array, Object fieldName) throws JSONException {
    ...
    public Object parse(Object fieldName) throws JSONException {
        final JSONScanner lexer = getLexer();
        switch (lexer.token()) {
            case SET:
                lexer.nextToken();
    ...
    public final void accept(final int token) throws JSONException {
        final JSONScanner lexer = getLexer();
